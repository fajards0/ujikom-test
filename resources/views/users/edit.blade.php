                    ...
                    <form action="{{ route('users.update', $user->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control border-2 border-gray-500 rounded-2 p-2"
                                placeholder="Masukkan nama pengguna" value="{{ $user->name }}" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-bold">Email</label>
                            <input type="email" name="email" class="form-control border-2 border-gray-500 rounded-2 p-2"
                                placeholder="Masukkan email pengguna" value="{{ $user->email }}" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-bold">Password (Kosongkan jika tidak ingin mengubah)</label>
                            <input type="password" name="password" class="form-control border-2 border-gray-500 rounded-2 p-2"
