    ...
    <div class="col-lg-4 col-md-6 mt-4 mb-4">
      <div class="card">
        <div class="card-body">
          ...
          <div class="pe-2">
            <div class="chart">
              <canvas id="chart-bars" class="chart-canvas" height="212" width="495" style="display: block; box-sizing: border-box; height: 170px; width: 396px;"></canvas>
            </div>
          </div>
    ...
    <div class="col-lg-4 col-md-6 mt-4 mb-4">
      <div class="card ">
        <div class="card-body">
          ...
          <div class="pe-2">
            <div class="chart">
              <canvas id="chart-line" class="chart-canvas" height="212" width="495" style="display: block; box-sizing: border-box; height: 170px; width: 396px;"></canvas>
            </div>
          </div>
          <hr class="dark horizontal">
          <div class="d-flex ">
    ...
    <div class="col-lg-4 mt-4 mb-3">
      <div class="card">
        <div class="card-body">
          ...
          <div class="pe-2">
            <div class="chart">
              <canvas id="chart-line-tasks" class="chart-canvas" height="212" width="1072" style="display: block; box-sizing: border-box; height: 170px; width: 857px;"></canvas>
            </div>
          </div>
          <hr class="dark horizontal">
          <div class="d-flex ">
