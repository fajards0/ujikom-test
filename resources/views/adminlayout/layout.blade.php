...
<body class="g-sidenav-show  bg-gray-100">
    ...
    @include('adminlayout.layout.atribut.sidebar')
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">

        @include('adminlayout.layout.atribut.nav')
        <div class="container-fluid py-2">

            @yield('content')

            @include('adminlayout.layout.atribut.footer')
        </div>
    </main>
    <!--   Core JS Files   -->
    ...
    <script src="https://demos.creative-tim.com/material-dashboard/assets/js/plugins/chartjs.min.js"></script>
    <script>
    ...
    <script src="https://demos.creative-tim.com/material-dashboard/assets/js/material-dashboard.min.js?v=3.2.0"></script>
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015"
        integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ=="
        data-cf-beacon='{"rayId":"90f8df52093744ab","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"version":"2025.1.0","token":"1b7cbb72744b40c580f8633c6b62637e"}'
